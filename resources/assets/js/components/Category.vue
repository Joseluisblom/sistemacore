                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="category in arrayCategoria" :key="category.id">
                                    <td>
                                        <button type="button" @click="abrirModal('category', 'actualizar', categoria)" class="btn btn-warning btn-sm">
                                    ...
                                    <td v-text="category.nombre"></td>
                                    <td v-text="category.descripcion"></td>
                                    <td>
                                        <div v-if="category.condicion">
                                             <span class="badge badge-success">Activo</span>
                                        </div>
                                         <div v-else="category.condicion">
